...
function renderPage(activeServiceOnEntry, pdfDocument, pageNumber, size, annotationStorage) {
...
function PDFPrintService(pdfDocument, pagesOverview, printContainer, l10n, annotationStorage) {
...
PDFPrintService.prototype = {
  ...
  renderPages() {
    ...
    const renderNextPage = (resolve, reject) => {
      ...
      renderPage(this, this.pdfDocument, index + 1, this.pagesOverview[index], this.annotationStorage)
...
PDFPrintServiceFactory.instance = {
  ...
  createPrintService(pdfDocument, pagesOverview, printContainer, l10n, annotationStorage) {
    if (activeService) {
