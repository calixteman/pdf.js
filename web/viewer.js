...
function getViewerConfiguration() {
  return {
    ...
    addSignatureDialog: {
      ...
      typePanel: document.getElementById("addSignatureTypeContainer"),
      drawButton: document.getElementById("addSignatureDrawButton"),
      drawPanel: document.getElementById("addSignatureDrawContainer"),
      ...
      imagePanel: document.getElementById("addSignatureImageContainer"),
